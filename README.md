...
- A [base class](https://github.com/tomduncalf/tomduncalf_juce_browser_integration/blob/main/BrowserIntegrationPluginClient.h) for plugins which automatically handles synchonising the plugins AudioProcessorValueTreeState to the browser, and a [corresponding class](https://github.com/tomduncalf/WebUISynth/blob/main/ui/src/juceIntegration/models/ParametersModel.ts) on the JS side which provides a representation of the parameters with getters and setters for easy modification.
...
- Lightweight mechanism for communicating between [Typescript](https://github.com/tomduncalf/tomduncalf_juce_browser_integration/blob/main/BrowserIntegrationClient.h#L21) and [C++](https://github.com/tomduncalf/tomduncalf_juce_browser_integration/blob/main/BrowserIntegrationClient.h#L21) by sending messages and registering callbacks.
